...
ActiveRecord::Schema[7.0].define(version: 2024_08_12_113000) do
  ...
  create_table "comparisons", charset: "utf8", force: :cascade do |t|
  ...
  create_table "users", charset: "utf8", force: :cascade do |t|
    ...
    t.datetime "updated_at", null: false
    t.string "name"
    t.boolean "first_sign_in", default: true, null: false
    t.boolean "first_memo", default: true, null: false
